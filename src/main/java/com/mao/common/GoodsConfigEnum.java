...
public enum GoodsConfigEnum {
    ...
    GoodsConfigEnum(int type, String name) {
        this.type = type;
        this.name = name;
    }

    public static GoodsConfigEnum getIndexConfigTypeEnumByType(int type) {
        for (GoodsConfigEnum indexConfigTypeEnum : GoodsConfigEnum.values()) {
